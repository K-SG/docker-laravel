...
@section('body')
<article>
  <form action="edit_schedule" method="post" class="schedule-edit-form" name="form">
	  @csrf
  ...
  <!-- 戻るボタン -->
  <div class="cancel-button"><img src="{{ asset('img/back_buttom.png') }}" alt="back-buttom" class="back-btn"></div>
  ...
  <div class="popup-wrapper error-popup">
    <div class="pop-container">
	  ...
	  <div class="pop-container-inner">
	    <div class="message-container"><p class=edit-msg></p></div>
